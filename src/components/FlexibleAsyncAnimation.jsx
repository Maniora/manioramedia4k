...
const FlexibleAsyncAnimation = () => {
    ...
    useEffect(() => {
        fetch('/assets/illustrations/flexibleasync.json')
        ...
        return (
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#f7e839]/10 to-[#f7e839]/5 rounded-full">
                <div className="text-center">
                    ...
                    <div className="text-[#f7e839] text-sm font-semibold">Async Communication</div>
                </div>
            </div>
        );
    }
...
export default FlexibleAsyncAnimation;
