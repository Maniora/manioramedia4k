        ...
        <div>
          ...
          <ul className="space-y-2">
            {servicesData.map((service) => (
              <FooterServiceItem key={service.id} service={service} />
            ))}
          </ul>
        </div>
