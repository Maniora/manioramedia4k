...
const OutdoorAnimation = () => {
  ...
  useEffect(() => {
    fetch('/assets/illustrations/outdoor.json')
        ...
        <div className="text-center">
          <div className="w-16 h-16 mx-auto mb-4 bg-[#f7e839] rounded-full flex items-center justify-center">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-[#11181f]">
              <rect x="3" y="16" width="18" height="5" rx="2" stroke="currentColor" strokeWidth="2"/>
            </svg>
          </div>
          <div className="text-[#f7e839] text-sm font-semibold">Outdoor Animation</div>
        </div>
      </div>
    );
  }
...
export default OutdoorAnimation;
