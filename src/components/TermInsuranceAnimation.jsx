...
const TermInsuranceAnimation = () => {
    ...
    useEffect(() => {
        fetch('/assets/illustrations/terminsurance.json')
                ...
                <div className="text-center">
                    <div className="w-16 h-16 mx-auto mb-4 bg-[#f7e839] rounded-full flex items-center justify-center">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-[#11181f]">
                            <path d="M12 2l6 3v5c0 5-3.5 9-6 12-2.5-3-6-7-6-12V5l6-3z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
                        </svg>
                    </div>
                    <div className="text-[#f7e839] text-sm font-semibold">Term Insurance</div>
                </div>
            </div>
        );
    }
...
export default TermInsuranceAnimation;
